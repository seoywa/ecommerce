...
ALTER TABLE "carts" ADD CONSTRAINT "carts_guest_id_guests_guest_id_fk" FOREIGN KEY ("guest_id") REFERENCES "public"."guests"("guest_id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
